    ...
    <>
      ...
      <section aria-label="Visual art gallery" className="bg-black py-32 px-6" data-bg="dark">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="font-adobe text-white/60 text-[16px] text-center max-w-[560px] mx-auto mb-12">
            Before Hunter was ever a touring musician, he was trained in visual
            arts at Eastern Kentucky University and specializes in hyperrealism
            charcoal drawings. Charcoal on paper.
          </p>
